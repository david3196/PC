...
class ProductsPage(QMainWindow):
    def __init__(self):
        ...
        self.sample_data1 = {
            "Product1": {"price": 100, "revenue": 700},
            "Product2": {"price": 200, "revenue": 800},
            "Product3": {"price": 300, "revenue": 1200},
            "Product4": {"price": 400, "revenue": 400},
            "Product5": {"price": 100, "revenue": 700},
            "Product6": {"price": 200, "revenue": 800},
            "Product7": {"price": 300, "revenue": 1200},
            "Product8": {"price": 400, "revenue": 400},
            "Product9": {"price": 400, "revenue": 400},
        }
    ...
    def init_main_layout(self):
        ...
        # Add the "post something new" section
        ...
        post_new_button = QPushButton("POST")

        post_new_layout.addWidget(post_new_button)
